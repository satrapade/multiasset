...
make_backtest_plot<-function(
  ...
  backtests<-mapply(
    function(stop_level)data.table(
      ...
      strategy=paste0("bkt_",round(stop_level*100,digits=0))
    ),
    stop_level=stop_levels,
    SIMPLIFY=FALSE
  )
  
  res<-do.call(rbind,c(list(data.table(dof[,.(date,pnl)],strategy="DOF")),backtests))
...
\begin{center}
\begin{tabular}{m{10cm} m{10cm}}
\Sexpr{make_plot(plot(make_backtest_plot("putspread")),height="10cm",width="10cm")}
&
\Sexpr{make_plot(plot(make_drawdown_plot("putspread")),height="10cm",width="10cm")}
\\
\Sexpr{make_plot(plot(make_sl_plot("putspread",c("max_draw","median_draw"))),height="10cm",width="10cm")}
&
\Sexpr{make_plot(plot(make_sl_plot("putspread",c("max_length","median_length"))),height="10cm",width="10cm")}
\\
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{m{10cm} m{10cm}}
\Sexpr{make_plot(plot(make_backtest_plot("tail1")),height="10cm",width="10cm")}
&
...
\begin{center}
\begin{tabular}{m{10cm} m{10cm}}
\Sexpr{make_plot(plot(make_backtest_plot("tail2")),height="10cm",width="10cm")}
&
\Sexpr{make_plot(plot(make_drawdown_plot("tail2")),height="10cm",width="10cm")}
\\
\Sexpr{make_plot(plot(make_sl_plot("tail2",c("max_draw","median_draw"))),height="10cm",width="10cm")}
&
\Sexpr{make_plot(plot(make_sl_plot("tail2",c("max_length","median_length"))),height="10cm",width="10cm")}
\\
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{m{10cm} m{10cm}}
\Sexpr{make_plot(plot(make_backtest_plot("tail5")),height="10cm",width="10cm")}
&
\Sexpr{make_plot(plot(make_drawdown_plot("tail5")),height="10cm",width="10cm")}
\\
\Sexpr{make_plot(plot(make_sl_plot("tail5",c("max_draw","median_draw"))),height="10cm",width="10cm")}
&
\Sexpr{make_plot(plot(make_sl_plot("tail5",c("max_length","median_length"))),height="10cm",width="10cm")}
\\
\end{tabular}
\end{center}
