...
g4<-backtest %>% 
  ggplot() +
  geom_line(aes(x=date,y=cash+holdings))+
...
\newpage
\section{Strategy, market backtests, 3m}
...
\newpage
\section{Strategy, market backtests, 6m (Jun, Dec)}
...
\newpage
\section{Strategy, market backtests, 6m (Mar, Sep)}
...
>>>>>>> 53839f5a901a30cffae53d20c5ca3e449f5e976c
