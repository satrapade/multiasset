...
#
weights<-list(
 equal=c(CSC=0.33,PSC=0.0,ZCRR=0.0,PR=0.33,CR=0.0,SS=0.33,TAIL1=0,TAIL2=0,TAIL5=0),
 theoretical=c(CSC=0.33,PSC=0.0,ZCRR=0.0,PR=0.33,CR=0.0,SS=0.33,TAIL1=0,TAIL2=0,TAIL5=0),
 historical=c(CSC=0.43,PSC=0.19,ZCRR=0.07,PR=0.15,CR=0.0,SS=0.16,TAIL1=0,TAIL2=0,TAIL5=0)
)
...
\\
\Sexpr{make_plot(plot(make_sl_plot(
  w="90-100 ps",
  backtest=spx_90_100_ps_backtest,
  v=c("max_draw","median_draw")
)),height="10cm",width="10cm")}
&
\Sexpr{make_plot(plot(make_sl_plot(
  w="90-100 ps",
  v=c("max_length","median_length"),
  backtest=spx_90_100_ps_backtest
)),height="10cm",width="10cm")}
\\
\end{tabular}
